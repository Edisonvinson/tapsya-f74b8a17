        ...
        >
          ...
          <div className="relative z-10 flex items-center min-h-[560px] md:min-h-[600px]">
            <div className="px-7 md:px-14 py-14 md:py-20 max-w-2xl">
              ...
              <p className="text-white/90 text-[15px] md:text-[16px] mt-6 max-w-lg leading-[1.7]">
                Same trusted therapists, same Kumily location — a brand new name and home.
                Visit us at{" "}
                <a
                  href={SITE_LINK}
                  target="_blank"
                ...
                to explore our therapies and book your session.
              </p>
