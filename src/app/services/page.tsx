...
const CATEGORIES: Category[] = [
  {
    ...
    treatments: [
      ...
      },
      {
        ...
        priceLine: "₹3,100 (60 Min) · Prices inclusive of all taxes",
        description:
    ...
    treatments: [
      {
        ...
        priceLine: "₹3,800 (60 Min) · Prices inclusive of all taxes",
        description:
      ...
      },
      {
        ...
        priceLine: "₹6,000 (60 Min) · Prices inclusive of all taxes",
        description:
  ...
  },
  {
    ...
    treatments: [
      ...
      },
      {
        ...
        priceLine: "₹3,800 (60 Min) · Price inclusive of all taxes",
        description:
          ...
          <div className="max-w-5xl mx-auto px-6 md:px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {cat.treatments.map((t) => {
                ...
                return <TreatmentCard key={id} id={id} treatment={t} image={img} />;
              })}
            </div>
          </div>
        </section>
...
function TreatmentCard({ id, treatment: t, image }: { id: string; treatment: Treatment; image: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="p-6 md:p-8 flex flex-col flex-1">
        <h3 className="font-serif font-semibold" style={{ color: "#00846d", fontSize: 22, lineHeight: 1.25 }}>
          {t.name}
        </h3>
        <p
          className="mt-2"
